...
description: User research analysis and synthesis framework for extracting insights from interviews, surveys, and behavioral data
tags: [product, user-research, synthesis, validation]
priority: 5
---
