...
### 14. Marketing Skills Collection (Phase 7 — Outreach Agent)
- **Source:** `coreyhaines31/marketingskills` (GitHub)
- **Repo:** https://github.com/coreyhaines31/marketingskills
- **What it is:** 30+ marketing skill markdown files covering: SEO analysis, content repurposing, social media campaigns, email sequences, growth experiments, competitive positioning, landing page optimization, A/B testing, audience research, funnel building
- **What to steal:** Pull 5-10 most relevant skill files as identity docs for the Outreach Agent (Phase 7 in build order). Focus on: landing page optimization, SEO analysis, email outreach sequences, competitive positioning.
- **Integration difficulty:** LOW — markdown skill files, same format as our existing identity docs
- **Priority:** PHASE 7 — needed when expanding Hands beyond coding to marketing/outreach domain
- **Why not now:** Outreach Agent doesn't exist yet. Currently in Phase 4 (Orchestrator). Bookmarked for Phase 7 execution.
- **Blocked by:** Phases 4-6 completion (Orchestrator → Signal Agent → Validation Agent → then Outreach Agent)
